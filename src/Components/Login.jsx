  ...
  return (
    <React.Fragment>
      ...
      <div className="row">
        ...
        <div className="col-sm-12 col-md-12 col-lg-5 text-center specta" style={{ backgroundColor: '#2d85de', maxWidth: '100%', maxHeight: '100vh'}}>
          <img src={ DisplayImage } alt="Display" className='sign-img' />
        </div>
        
        {/* Right Column with Login Form */}
        <div className="col-sm-12 col-md-12 col-lg-7 ajaz" style={{ backgroundImage: `url(${Background2})`, backgroundRepeat: 'no-repeat', maxHeight: '100vh', backgroundSize: 'cover', backgroundPosition: 'center center' }}>
